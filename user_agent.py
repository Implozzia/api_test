...
class TestUserAgent:
    ...
    def test_user_agent(self, user_agent, expected_platform, expected_browser, expected_device):
        ...
        assert actual_platform == expected_platform, f'We expected {expected_platform}, but actually have {actual_platform}'
        assert actual_browser == expected_browser, f'We expected {expected_browser}, but actually have {actual_browser}'
        assert actual_device == expected_device, f'We expected {expected_device}, but actually have {actual_device}'
